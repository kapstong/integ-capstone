...
(function() {
    ...
    function createWarningModal() {
        // Create modal HTML
        const modalHTML = `
            <div id="inactivity-warning-modal" style="display: none; position: fixed; z-index: 99999; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.7); align-items: center; justify-content: center;">
