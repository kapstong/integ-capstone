...
$configFile = __DIR__ . '/../../config/integrations/logistics2.json';
$config = ['api_url' => 'https://logistic2.atierahotelandrestaurant.com/integration/trip-costs-api.php'];
...
$apiUrl = $config['api_url'] ?? 'https://logistic2.atierahotelandrestaurant.com/integration/trip-costs-api.php';
$externalParams = $_GET;
...
api_send([
    'success' => true,
    'endpoint' => '/api/logistics/trip-costs',
    'source' => $apiUrl,
    'data' => $data
]);
