...
$configFile = __DIR__ . '/../../config/integrations/logistics1.json';
$config = ['api_url' => 'https://logistics1.atierahotelandrestaurant.com/api/procurement/purchase-order.php'];
...
$apiUrl = $config['api_url'] ?? 'https://logistics1.atierahotelandrestaurant.com/api/procurement/purchase-order.php';
$externalParams = $_GET;
...
api_send([
    'success' => true,
    'endpoint' => '/api/logistics/procurement',
    'source' => $apiUrl,
    'data' => $data
]);
